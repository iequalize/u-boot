...
#if 0
#define CONFIG_CMD_EEPROM /* no eeprom, no tempsensor on TQMa28L */
...
#define MXS_UARTAPP_BASE		MXS_UARTAPP1_BASE
#define CONFIG_BAUDRATE			115200	/* Default baud rate */
#define CONFIG_SYS_LINUX_CONSOLE	ttyAPP1
...
#define CONFIG_MXS_I2C_BASE	MXS_I2C0_BASE
